  ...
  return (
    ...
    >
      <div className='sentiment-head'>
        <a href="/home"className='sentiment-headleft'>TUNIZI</a>
        <div className='sentiment-headright'></div>
        <button className='signup-button'> <a href="/signup" style={{ color: "white", textDecoration: "none" }}> SIGN UP</a> </button>
        <button className='signin-button' > <a href="/login" style={{ color: "black", textDecoration: "none" }}> SIGN IN</a></button>
      </div>
